...
900
normal zo
let s:l = 627 - ((18 * winheight(0) + 19) / 38)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 10 - ((4 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
798
normal zo
let s:l = 120 - ((12 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
normal! 0
tabedit io_libtcod.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 41 - ((21 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 29 - ((14 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
765
normal zo
let s:l = 900 - ((37 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
900
...
51
normal zc
let s:l = 226 - ((23 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
226
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((22 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
1107
normal zo
let s:l = 1024 - ((71 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1024
...
103
normal zc
let s:l = 107 - ((68 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
...
73
normal zo
let s:l = 87 - ((18 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
