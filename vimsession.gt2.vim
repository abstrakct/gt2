...
424
normal zo
let s:l = 551 - ((22 * winheight(0) + 14) / 28)
...
79
normal zo
let s:l = 57 - ((12 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
10
normal zo
let s:l = 44 - ((25 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 28 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
...
99
normal zo
let s:l = 38 - ((27 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((18 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
40
normal zo
let s:l = 69 - ((27 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
138
normal zo
let s:l = 143 - ((55 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
143
...
81
normal zo
let s:l = 77 - ((63 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
77
...
40
normal zo
let s:l = 78 - ((21 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
